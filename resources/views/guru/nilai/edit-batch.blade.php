...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold text-warning">
            <i class="bi bi-pencil-square me-2"></i> Edit Nilai Batch
        </h1>
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-warning text-dark">
            <h6 class="mb-0">
                <i class="bi bi-info-circle me-2"></i> Informasi Edit Nilai
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="bi bi-table me-2"></i> Tabel Edit Nilai Siswa
            </h5>
                    ...
                    <table class="table table-hover table-striped mb-0">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th style="width: 25%">Edit Nilai</th>
                            ...
                            @forelse($jadwal->kelas->siswas as $index => $siswa)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="text-muted">Tidak ada nilai untuk diedit</span>
                                        @endif
                                    </td>
                    ...
                    <div class="card-footer bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-secondary" onclick="resetAllNilai()">
                                    <i class="bi bi-arrow-clockwise me-1"></i> Reset All
                                </button>
                                <button type="submit" class="btn btn-warning">
                                    <i class="bi bi-save me-1"></i> Update Semua Nilai
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card shadow-sm border-0 mt-4">
        <div class="card-header bg-info text-white">
            <h6 class="mb-0">
                <i class="bi bi-lightbulb me-2"></i> Tips Edit Nilai
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul class="mb-0">
                        ...
                        <li>Hanya nilai yang sudah ada yang dapat diedit</li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <h6 class="fw-semibold">Fitur Batch Edit:</h6>
                    <ul class="mb-0">
                        <li>Edit semua nilai sekaligus</li>
                        <li>Update nilai yang sudah ada</li>
